        ...
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <form name="repairAdd" class="col-12" action="approvalUpdate.php" method="POST" enctype="multipart/form-data">
                                <!-- Display report data -->
                            ...
                            <div class="block-header section-title">
                                ...
                                <?php include_once("approvalFormUpd.php"); ?>
