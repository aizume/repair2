...
<div class="row input-group input-group-outline" id="approval_comment_row" style="display: none;">
...
<script>
    // ฟังก์ชันแสดงหรือซ่อนความคิดเห็นเมื่อเลือกไม่อนุมัติ
    function toggleApprovalComment() {
        const approvalStatus = document.getElementById('approval_status').value;
        const commentRow = document.getElementById('approval_comment_row');

        if (approvalStatus === 'ไม่อนุมัติ') {
