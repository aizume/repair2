...
<div class="row input-group input-group-outline">
    ...
    <div class="col-md-6">
        <input type="text" class="form-control" id="sch_topic" name="sch_topic" value="<?php echo htmlspecialchars($schedule['sch_topic']); ?>" placeholder="เช่น ไปซ่อมเครื่องปรับอากาศ">
    </div>
</div>
<br>
...
<div class="row input-group input-group-outline">
    ...
    <div class="col-md-6">
        <input type="date" class="form-control" id="sch_date" name="sch_date" value="<?php echo $schedule['sch_date']; ?>" required>
    </div>
</div>
<br>
...
<div class="row input-group input-group-outline">
    ...
    <div class="col-md-6">
        <input type="time" class="form-control" id="sch_time" name="sch_time" value="<?php echo $schedule['sch_time']; ?>" required>
    </div>
</div>
<br>
...
<div class="row input-group input-group-outline">
    ...
    <div class="col-md-6">
        <textarea class="form-control" id="details" name="details" rows="4"><?php echo htmlspecialchars($schedule['details']); ?></textarea>
    </div>
</div>
<br>
