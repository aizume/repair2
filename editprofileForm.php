...
<!-- ยืนยันรหัสผ่าน -->
<div class="row input-group input-group-outline">
    <label class="col-form-label col-md-3 text-right" for="confirmPassword">ยืนยันรหัสผ่าน (Confirm Password) <span class="text-danger">*</span></label>
    <div class="col-md-6 password-container">
        ...
        <span class="toggle-password" onclick="togglePassword()">
            <i class="material-icons" id="confirmPasswordIcon">visibility_off</i>
        </span>
...
<div class="row input-group input-group-outline">
    ...
    <div class="col-md-6">
        <input type="text" class="form-control" id="per_lastname" name="per_lastname" value="<?php echo $per_lastname; ?>" required>
    </div>
</div>
...
<div class="row input-group input-group-outline">
    ...
    <div class="col-md-6">
        <input type="text" class="form-control" id="per_id_card" name="per_id_card" value="<?php echo $per_id_card; ?>" required>
    </div>
</div>
...
<div class="row input-group input-group-outline">
    ...
    <div class="col-md-6">
        <input type="email" class="form-control" id="per_email" name="per_email" value="<?php echo $per_email; ?>">
    </div>
</div>
...
<div class="row input-group input-group-outline">
    ...
    <div class="col-md-6">
        <input type="text" class="form-control" id="per_tel" name="per_tel" value="<?php echo $per_tel; ?>" required>
    </div>
</div>
...
<div class="row input-group input-group-outline">
    ...
    <div class="col-md-6">
        ...
        <div class="mt-2">
            <!-- ใช้ค่า $signature_image จากฐานข้อมูล -->
            <img id="current_image_preview" src="<?php echo $signature_image; ?>" alt="รูปภาพลายเซ็นปัจจุบัน" style="max-width: 200px;">
        </div>
        <?php else: ?>
...
<br>
<div class="row input-group input-group-outline">
    <label class="col-form-label col-md-3 text-right">ตัวอย่างรูปภาพใหม่</label>
    <div class="col-md-6">
        <img id="image_preview" src="#" alt="รูปภาพตัวอย่างใหม่" style="display:none; max-width: 100%; height: auto;">
    </div>
</div>
<br>
